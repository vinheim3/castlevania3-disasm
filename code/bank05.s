...
B5_0703:		lda wCurrRoomGroup		; a5 32
...
B5_0769:		sta wEntityGenericCounter.w, x	; 9d 33 06
B5_076c:		ldy $08			; a4 08
B5_076e:		lda $a780, y	; b9 80 a7
B5_0771:		sta wPlayerStateDoubled.w, x	; 9d 65 05
...
B5_08cd:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_08e1:		sta wEntityGenericCounter.w, x	; 9d 33 06
...
B5_08fd:		sta wEntityGenericCounter.w, x	; 9d 33 06
...
B5_0912:		lda wEntityObjectIdxes.w, x	; bd 4e 05
...
B5_091d:		lda wEntityGenericCounter.w, x	; bd 33 06
...
B5_092f:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_0984:		lda wCurrRoomGroup		; a5 32
...
B5_09a8:		sta wPlayerStateDoubled.w, x	; 9d 65 05
B5_09ab:		lda $0c			; a5 0c
B5_09ad:		sta wEntityGenericCounter.w, x	; 9d 33 06
...
B5_09f7:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B5_0a00:		asl a			; 0a
B5_0a01:		clc				; 18 
B5_0a02:		adc wEntityBaseX.w, x	; 7d 38 04
B5_0a05:		sta wEntityBaseX.w, x	; 9d 38 04
...
B5_0a3a:		lda wCurrRoomGroup		; a5 32
B5_0a3c:		cmp #$0a		; c9 0a
B5_0a3e:		bne B5_0a4e ; d0 0e

B5_0a40:		lda wCurrRoomSection			; a5 33
...
B5_0aa2:		jsr clearAllEntityVars_todo		; 20 d7 fe
...
B5_0abc:		sta wEntityBaseX.w, x	; 9d 38 04
B5_0abf:		lda $04			; a5 04
B5_0ac1:		sta wEntityBaseY.w, x	; 9d 1c 04
B5_0ac4:		lda #$00		; a9 00
B5_0ac6:		sta wEntityAI_idx.w, x	; 9d ef 05
B5_0ac9:		lda $01			; a5 01
B5_0acb:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
B5_0ace:		rts				; 60 


B5_0acf:		ldx #$03		; a2 03
B5_0ad1:		lda wEntityObjectIdxes.w, x	; bd 4e 05
...
B5_0ae7:		lda wEntityBaseY.w, x	; bd 1c 04
B5_0aea:		cmp #$f0		; c9 f0
B5_0aec:		bcs B5_0aff ; b0 11

B5_0aee:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B5_0af1:		adc #$20		; 69 20
B5_0af3:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B5_0af6:		lda wEntityVertSpeed.w, x	; bd 20 05
B5_0af9:		adc #$00		; 69 00
B5_0afb:		sta wEntityVertSpeed.w, x	; 9d 20 05
B5_0afe:		rts				; 60 


B5_0aff:		jsr clearAllEntityVars_todo		; 20 d7 fe
B5_0b02:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_0b0e:		tya				; 98 
B5_0b0f:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_0b21:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_0b54:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
B5_0b57:		lda #$01		; a9 01
B5_0b59:		sta wPlayerStateDoubled.w, x	; 9d 65 05
...
B5_0bf9:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B5_0bfc:		sta wEntityVertSpeed.w, x	; 9d 20 05
...
B5_0c0a:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B5_0c0d:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B5_0c10:		jmp $ad2d		; 4c 2d ad


B5_0c13:		jsr $ac1f		; 20 1f ac
B5_0c16:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B5_0c26:		lda wEntityBaseY.w, x	; bd 1c 04
...
B5_0c2e:		lda wEntityBaseY.w, x	; bd 1c 04
...
B5_0c3f:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
...
B5_0c70:		sta wEntityBaseX.w, x	; 9d 38 04
B5_0c73:		lda #$00		; a9 00
B5_0c75:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
...
B5_0c89:		tya				; 98 
B5_0c8a:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B5_0d34:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_0dc9:		clc				; 18 
B5_0dca:		lda wEntityHorizSubSpeed.w, x	; bd 09 05
B5_0dcd:		adc $ae50, y	; 79 50 ae
B5_0dd0:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B5_0dd3:		lda wEntityHorizSpeed.w, x	; bd f2 04
B5_0dd6:		adc $ae51, y	; 79 51 ae
B5_0dd9:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B5_0ddc:		rts				; 60 


B5_0ddd:		lda wEntityHorizSpeed.w, x	; bd f2 04
B5_0de0:		pha				; 48 
...
B5_0e0d:		cmp wEntityGenericCounter.w, x	; dd 33 06
B5_0e10:		rts				; 60 
...
B5_0e2e:		clc				; 18 
B5_0e2f:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B5_0e32:		adc $ae50, y	; 79 50 ae
B5_0e35:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B5_0e38:		lda wEntityVertSpeed.w, x	; bd 20 05
B5_0e3b:		adc $ae51, y	; 79 51 ae
B5_0e3e:		sta wEntityVertSpeed.w, x	; 9d 20 05
B5_0e41:		rts				; 60 


B5_0e42:		lda wEntityVertSpeed.w, x	; bd 20 05
B5_0e45:		pha				; 48 
...
B5_0e9e:		sta wEntityBaseY.w, x	; 9d 1c 04
B5_0ea1:		iny				; c8 
B5_0ea2:		lda ($9a), y	; b1 9a
B5_0ea4:		sta wEntityGenericCounter.w, x	; 9d 33 06
B5_0ea7:		iny				; c8 
...
B5_0ebb:		sbc wEntityHorizSubSpeed.w, x	; fd 09 05
B5_0ebe:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B5_0ec1:		lda #$00		; a9 00
B5_0ec3:		sbc wEntityHorizSpeed.w, x	; fd f2 04
B5_0ec6:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B5_0ec9:		rts				; 60 
...
B5_0ed4:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B5_0ed7:		lda $af0d, y	; b9 0d af
B5_0eda:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B5_0edd:		rts				; 60 
...
B5_0ee9:		sbc wEntityVertSubSpeed.w, x	; fd 37 05
B5_0eec:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B5_0eef:		lda #$00		; a9 00
B5_0ef1:		sbc wEntityVertSpeed.w, x	; fd 20 05
B5_0ef4:		sta wEntityVertSpeed.w, x	; 9d 20 05
B5_0ef7:		rts				; 60 
...
B5_0f02:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B5_0f05:		lda $af0d, y	; b9 0d af
B5_0f08:		sta wEntityVertSpeed.w, x	; 9d 20 05
B5_0f0b:		rts				; 60 
...
B5_0f1e:		clc				; 18 
B5_0f1f:		lda wEntityHorizSubSpeed.w, x	; bd 09 05
...
B5_0f42:		clc				; 18 
B5_0f43:		lda wEntityVertSubSpeed.w, x	; bd 37 05
...
B5_0f6d:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_0fb6:		lda wEntityBaseY.w, x	; bd 1c 04
...
B5_0ff6:		lda wEntityBaseY.w, x	; bd 1c 04
B5_0ff9:		adc $0793, x	; 7d 93 07
B5_0ffc:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B5_1006:		lda wCurrRoomMetadataByte			; a5 68
B5_1008:		bmi B5_101f ; 30 15

B5_100a:		lda wEntityBaseY.w, x	; bd 1c 04
B5_100d:		clc				; 18 
B5_100e:		adc #$08		; 69 08
B5_1010:		tay				; a8 
B5_1011:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_1023:		jsr func_1f_1c1e		; 20 1e fc
...
B5_108d:		.db $00				; 00
B5_108e:		.db $00				; 00
B5_108f:		lda wCurrRoomMetadataByte			; a5 68
...
B5_10a7:		lda wEntityBaseX.w, x	; bd 38 04
B5_10aa:		sec				; 38 
B5_10ab:		sbc $6e			; e5 6e
B5_10ad:		sta wEntityBaseX.w, x	; 9d 38 04
...
B5_10f4:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_1132:		lda wEntityBaseY.w, x	; bd 1c 04
B5_1135:		clc				; 18 
B5_1136:		adc $6e			; 65 6e
B5_1138:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B5_114f:		sec				; 38 
B5_1150:		sbc wEntityBaseX.w, x	; fd 38 04
...
B5_115b:		lda wEntityBaseY.w		; ad 1c 04
B5_115e:		sec				; 38 
B5_115f:		sbc wEntityBaseY.w, x	; fd 1c 04
...
B5_1191:		lda wEntityBaseY.w		; ad 1c 04
B5_1194:		clc				; 18 
...
B5_11ad:		lda wEntityFacingLeft.w		; ad a8 04
B5_11b0:		beq B5_11c2 ; f0 10

B5_11b2:		lda wEntityBaseX.w		; ad 38 04
B5_11b5:		sec				; 38 
...
B5_11c2:		lda wEntityBaseX.w		; ad 38 04
B5_11c5:		clc				; 18 
...
B5_11d3:		sec				; 38 
B5_11d4:		sbc wEntityBaseX.w, x	; fd 38 04
...
B5_123c:	.db $03
B5_123d:	.db $03
B5_123e:		lda wEntityBaseX.w, x	; bd 38 04
B5_1241:		sta $04			; 85 04
B5_1243:		lda wEntityBaseY.w, x	; bd 1c 04
B5_1246:		sta $05			; 85 05
B5_1248:		ldx #$14		; a2 14
B5_124a:		lda wEntityObjectIdxes.w, x	; bd 4e 05
...
B5_1266:		lda wEntityBaseY.w, x	; bd 1c 04
B5_1269:		sec				; 38 
B5_126a:	.db $f9 $0d $00
...
B5_1275:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_12b1:		lda wEntityBaseY.w, x	; bd 1c 04
B5_12b4:		sec				; 38 
...
B5_12bf:		lda wEntityBaseY.w, x	; bd 1c 04
B5_12c2:		clc				; 18 
...
B5_12ce:		lda wEntityBaseY.w, x	; bd 1c 04
...
B5_1348:		lda wCurrPlayer.w		; ad 4e 05
...
B5_13a6:		lsr a			; 4a
B5_13a7:		clc				; 18 
B5_13a8:		adc wVramQueueDest			; 65 61
...
B5_13f1:		jsr func_1f_1c1e		; 20 1e fc
B5_13f4:		lda wEntityBaseX.w, x	; bd 38 04
...
B5_140d:		lda wCurrRoomMetadataByte			; a5 68
...
B5_1426:		sta wVramQueueDest+1			; 85 62
...
B5_1437:		sta wVramQueueDest			; 85 61
B5_1439:		lda $0a			; a5 0a
B5_143b:		lsr a			; 4a
B5_143c:		lsr a			; 4a
B5_143d:		lsr a			; 4a
B5_143e:		clc				; 18 
B5_143f:		adc wVramQueueDest			; 65 61
B5_1441:		sta wVramQueueDest			; 85 61
...
B5_1460:		jsr setVramQueueFillIdxAndTerminate		; 20 de e8
...
B5_1475:		jsr setVramQueueFillIdxAndTerminate		; 20 de e8
...
B5_14d5:		lda wEntityObjectIdxes.w, x	; bd 4e 05
...
B5_14e4:		sta wEntityObjectIdxes.w, x	; 9d 4e 05
B5_14e7:		lda #$00		; a9 00
B5_14e9:		sta wPlayerStateDoubled.w, x	; 9d 65 05
...
B5_1501:		sta wEntityBaseX.w, x	; 9d 38 04
B5_1504:		lda $b541, y	; b9 41 b5
B5_1507:		clc				; 18 
B5_1508:		adc $05			; 65 05
B5_150a:		sta wEntityBaseY.w, x	; 9d 1c 04
B5_150d:		lda $b542, y	; b9 42 b5
B5_1510:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B5_1513:		lda $b543, y	; b9 43 b5
B5_1516:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B5_1519:		lda $b544, y	; b9 44 b5
B5_151c:		sta wEntityVertSpeed.w, x	; 9d 20 05
B5_151f:		lda $b545, y	; b9 45 b5
B5_1522:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B5_170b:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B5_17cc:		stx wVramQueueNextIdxToFill			; 86 1d
B5_17ce:		ldx $17			; a6 17
B5_17d0:		lda $06			; a5 06
B5_17d2:		sta wVramQueue.w, x	; 9d 00 03
B5_17d5:		rts				; 60 


B5_17d6:		sta wVramQueue.w, x	; 9d 00 03
...
B5_17f3:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B5_187b:		stx wVramQueueNextIdxToFill			; 86 1d
B5_187d:		rts				; 60 
...
B5_18b6:		stx wVramQueueNextIdxToFill			; 86 1d
B5_18b8:		rts				; 60 
...
B5_18f6:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B5_196f:		stx wVramQueueNextIdxToFill			; 86 1d
...
B5_1995:		sta wVramQueue.w, x	; 9d 00 03
B5_1998:		inx				; e8 
B5_1999:		rts				; 60 
...
B5_1a79:		sta wNametableMapping			; 85 25
B5_1a7b:		rts				; 60 
...
B5_1a82:		ror a			; 6a
B5_1a83:		pha				; 48 
B5_1a84:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B5_1aae:		stx wVramQueueNextIdxToFill			; 86 1d
...
B5_1ccf:	.db $53
B5_1cd0:		.db $00				; 00
B5_1cd1:		ror wVramQueueDest			; 66 61
B5_1cd3:	.db $62
