...
B4_0070:		lda wEntityAI_idx.w, x	; bd ef 05
...
B4_0081:		lda wEntityPhase.w, x	; bd c1 05
B4_0084:		asl a			; 0a
B4_0085:		asl a			; 0a
B4_0086:		clc				; 18 
...
B4_02af:		lda wEntityState.w, x	; bd 70 04
B4_02b2:		ora #$88		; 09 88
B4_02b4:		sta wEntityState.w, x	; 9d 70 04
B4_02b7:		lda #$02		; a9 02
B4_02b9:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B4_02bc:		lda #$14		; a9 14
B4_02be:		sta $00			; 85 00
B4_02c0:		lda wCurrRoomGroup		; a5 32
...
B4_02e9:		lda wCurrRoomGroup		; a5 32
...
B4_0393:		lda wEntityBaseX.w, x	; bd 38 04
B4_0396:		clc				; 18 
B4_0397:		adc #$10		; 69 10
B4_0399:		sta wEntityBaseX.w, x	; 9d 38 04
B4_039c:		bcc B4_03aa ; 90 0c

B4_039e:		lda wEntityState.w, x	; bd 70 04
B4_03a1:		and #$01		; 29 01
B4_03a3:		eor #$01		; 49 01
B4_03a5:		ora #$88		; 09 88
B4_03a7:		sta wEntityState.w, x	; 9d 70 04
B4_03aa:		lda wCurrRoomGroup		; a5 32
...
B4_03c7:		sta wEntityState.w, x	; 9d 70 04
B4_03ca:		lda wEntityAI_idx.w, x	; bd ef 05
...
B4_03da:		lda wEntityPhase.w, x	; bd c1 05
B4_03dd:		cmp #$02		; c9 02
B4_03df:		bne B4_03f7 ; d0 16

B4_03e1:		lda wEntityBaseY.w, x	; bd 1c 04
B4_03e4:		cmp #$f8		; c9 f8
B4_03e6:		bcc B4_03f7 ; 90 0f

B4_03e8:		inc wEntityPhase.w, x	; fe c1 05
...
B4_0405:		lda wEntityBaseX.w, x	; bd 38 04
...
B4_0410:		lda wEntityBaseX.w, x	; bd 38 04
B4_0413:		and #$0f		; 29 0f
B4_0415:		ora #$e0		; 09 e0
B4_0417:		sta wEntityBaseX.w, x	; 9d 38 04
B4_041a:		rts				; 60 


B4_041b:		lda wEntityState.w, x	; bd 70 04
...
B4_047e:		clc				; 18 
B4_047f:		adc wPlayerStateDoubled.w, x	; 7d 65 05
...
B4_04e8:		lda wEntityState.w, x	; bd 70 04
B4_04eb:		and #$77		; 29 77
B4_04ed:		sta wEntityState.w, x	; 9d 70 04
B4_04f0:		jsr $8627		; 20 27 86
B4_04f3:		jsr $8661		; 20 61 86
B4_04f6:		lda #$00		; a9 00
B4_04f8:		sta wEntityFacingLeft.w, x	; 9d a8 04
B4_04fb:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_0515:		sec				; 38 
B4_0516:		sbc wPlayerStateDoubled.w, x	; fd 65 05
B4_0519:		clc				; 18 
B4_051a:		lsr a			; 4a
B4_051b:		lsr a			; 4a
B4_051c:		lsr a			; 4a
...
B4_063a:		lda wEntityState.w, x	; bd 70 04
B4_063d:		ora #$88		; 09 88
B4_063f:		sta wEntityState.w, x	; 9d 70 04
...
B4_0653:		lda wEntityState.w, x	; bd 70 04
B4_0656:		ora #$88		; 09 88
B4_0658:		sta wEntityState.w, x	; 9d 70 04
B4_065b:		lda $0d			; a5 0d
B4_065d:		sta wEntityBaseX.w, x	; 9d 38 04
B4_0660:		rts				; 60 
...
B4_0674:		lda wEntityState.w, x	; bd 70 04
B4_0677:		ora #$88		; 09 88
B4_0679:		sta wEntityState.w, x	; 9d 70 04
...
B4_068d:		lda wEntityState.w, x	; bd 70 04
B4_0690:		ora #$88		; 09 88
B4_0692:		sta wEntityState.w, x	; 9d 70 04
B4_0695:		lda $0f			; a5 0f
B4_0697:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_069a:		rts				; 60 


B4_069b:		lda wCurrRoomMetadataByte			; a5 68
B4_069d:		bpl B4_06a4 ; 10 05

B4_069f:		lda #$30		; a9 30
B4_06a1:		sta wEntityBaseX.w, x	; 9d 38 04
...
B4_06ee:		lda wEntityState.w, x	; bd 70 04
B4_06f1:		ora #$88		; 09 88
B4_06f3:		sta wEntityState.w, x	; 9d 70 04
B4_06f6:		rts				; 60 
...
B4_0718:		lda wCurrRoomSection			; a5 33
...
B4_0770:		lda wCurrRoomMetadataByte			; a5 68
...
B4_078f:		sta wEntityState.w, y	; 99 70 04
B4_0792:		lda $03			; a5 03
B4_0794:		sta wEntityBaseX.w, y	; 99 38 04
B4_0797:		lda #$30		; a9 30
B4_0799:		sta wEntityBaseY.w, y	; 99 1c 04
B4_079c:		lda $08			; a5 08
B4_079e:		sta wEntityAI_idx.w, y	; 99 ef 05
B4_07a1:		lda #$00		; a9 00
B4_07a3:		sta wEntityPaletteOverride.w, y	; 99 54 04
...
B4_07bb:		jsr func_1f_1c1e		; 20 1e fc
...
B4_0811:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_0820:		lda wEntityState.w, x	; bd 70 04
B4_0823:		ora #$40		; 09 40
B4_0825:		sta wEntityState.w, x	; 9d 70 04
B4_0828:		lda wEntityAI_idx.w, x	; bd ef 05
...
B4_0833:		lda wEntityPhase.w, x	; bd c1 05
B4_0836:		bne B4_0846 ; d0 0e

B4_0838:		lda #$04		; a9 04
B4_083a:		ldy #$08		; a0 08
B4_083c:		jsr func_1f_1c1e		; 20 1e fc
B4_083f:		beq B4_0846 ; f0 05

B4_0841:		lda #$1b		; a9 1b
B4_0843:		sta wEntityPhase.w, x	; 9d c1 05
B4_0846:		lda wEntityPhase.w, x	; bd c1 05
...
B4_0850:		lda wEntityPhase.w, x	; bd c1 05
...
B4_088c:		inc wEntityPhase.w, x	; fe c1 05
B4_088f:		jmp $8070		; 4c 70 80


B4_0892:		lda wCurrRoomMetadataByte			; a5 68
B4_0894:		bmi B4_08a3 ; 30 0d

B4_0896:		lda wEntityBaseY.w, x	; bd 1c 04
B4_0899:		and #$f0		; 29 f0
B4_089b:		ora #$08		; 09 08
B4_089d:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_08a0:		jmp clearEntityHorizVertSpeeds		; 4c c8 fe
...
B4_08b4:		jmp clearEntityHorizVertSpeeds		; 4c c8 fe
...
B4_08c9:		lda wEntityBaseY.w		; ad 1c 04
B4_08cc:		cmp wEntityBaseY.w, x	; dd 1c 04
...
B4_08ee:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B4_08f1:		lda $061d, x	; bd 1d 06
B4_08f4:		sta $00			; 85 00
B4_08f6:		lda wPlayerStateDoubled.w		; ad 65 05
B4_08f9:		sta $061d, x	; 9d 1d 06
B4_08fc:		lda wEntityAI_idx.w, x	; bd ef 05
B4_08ff:		beq B4_0904 ; f0 03

B4_0901:		jmp $89ad		; 4c ad 89


B4_0904:		lda wEntityState.w, x	; bd 70 04
B4_0907:		and #$01		; 29 01
B4_0909:		bne B4_0914 ; d0 09

B4_090b:		lda wEntityBaseY.w		; ad 1c 04
B4_090e:		sec				; 38 
B4_090f:		sbc wEntityBaseY.w, x	; fd 1c 04
...
B4_0923:		lda wEntityBaseX.w		; ad 38 04
B4_0926:		sec				; 38 
B4_0927:		sbc wEntityBaseX.w, x	; fd 38 04
...
B4_093e:		lda wPlayerStateDoubled.w		; ad 65 05
...
B4_094b:		lda wPlayerStateDoubled.w		; ad 65 05
...
B4_0958:		lda wPlayerStateDoubled.w		; ad 65 05
...
B4_0965:		lda wPlayerStateDoubled.w		; ad 65 05
...
B4_0976:		sta wEntityFacingLeft.w, x	; 9d a8 04
B4_0979:		jmp $8983		; 4c 83 89


B4_097c:		lda $00			; a5 00
B4_097e:		eor #$01		; 49 01
B4_0980:		sta wEntityFacingLeft.w, x	; 9d a8 04
...
B4_098e:		lda wEntityState.w, x	; bd 70 04
B4_0991:		and #$01		; 29 01
B4_0993:		sta wEntityState.w, x	; 9d 70 04
...
B4_09ad:		lda wEntityAI_idx.w, x	; bd ef 05
B4_09b0:		cmp #$07		; c9 07
B4_09b2:		bne B4_09c0 ; d0 0c

B4_09b4:		lda wEntityPhase.w, x	; bd c1 05
...
B4_09c3:		lda wEntityState.w, x	; bd 70 04
B4_09c6:		ora #$88		; 09 88
B4_09c8:		sta wEntityState.w, x	; 9d 70 04
B4_09cb:		lda wEntityBaseX.w, x	; bd 38 04
...
B4_0a19:		lda wEntityState.w, x	; bd 70 04
...
B4_0a28:		lda wEntityFacingLeft.w		; ad a8 04
...
B4_0a68:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B4_0a84:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B4_0a87:		lda wEntityState.w, x	; bd 70 04
B4_0a8a:		and #$01		; 29 01
B4_0a8c:		beq B4_0a98 ; f0 0a

B4_0a8e:		lda wEntityState.w, x	; bd 70 04
B4_0a91:		ora #$88		; 09 88
B4_0a93:		sta wEntityState.w, x	; 9d 70 04
...
B4_0ac7:		lda wEntityBaseY.w, x	; bd 1c 04
B4_0aca:		sec				; 38 
B4_0acb:		sbc #$08		; e9 08
B4_0acd:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_0ad0:		lda #$10		; a9 10
B4_0ad2:		sta $05d8, x	; 9d d8 05
B4_0ad5:		dec $05d8, x	; de d8 05
B4_0ad8:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_0b13:		sta wPlayerStateDoubled.w, x	; 9d 65 05
B4_0b16:		lda wEntityBaseY.w, x	; bd 1c 04
B4_0b19:		clc				; 18 
B4_0b1a:		adc #$08		; 69 08
B4_0b1c:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_0b1f:		lda #$04		; a9 04
B4_0b21:		sta $05d8, x	; 9d d8 05
B4_0b24:		dec $05d8, x	; de d8 05
B4_0b27:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_0b5b:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B4_0bac:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_0bdf:		lda wCurrRoomGroup		; a5 32
...
B4_0c38:		lda wEntityBaseY.w, x	; bd 1c 04
B4_0c3b:		sta $0645, x	; 9d 45 06
B4_0c3e:		stx $17			; 86 17
B4_0c40:		lda wCurrRoomGroup		; a5 32
...
B4_0c55:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_0c9d:		stx wVramQueueNextIdxToFill			; 86 1d
B4_0c9f:		ldx $17			; a6 17
B4_0ca1:		rts				; 60 


B4_0ca2:		sta wVramQueue.w, x	; 9d 00 03
B4_0ca5:		inx				; e8 
B4_0ca6:		rts				; 60 
...
B4_0d0a:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_0d61:		stx wVramQueueNextIdxToFill			; 86 1d
B4_0d63:		rts				; 60 
...
B4_0da4:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_0deb:		adc wPlayerStateDoubled.w, x	; 7d 65 05
...
B4_0e0a:		sta wPlayerStateDoubled.w, x	; 9d 65 05
B4_0e0d:		sec				; 38 
...
B4_0e44:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_0e61:		sta wEntityState.w, x	; 9d 70 04
B4_0e64:		jsr $8627		; 20 27 86
B4_0e67:		jsr $8661		; 20 61 86
B4_0e6a:		lda wEntityState.w, x	; bd 70 04
B4_0e6d:		beq B4_0e74 ; f0 05

B4_0e6f:		ora #$01		; 09 01
B4_0e71:		sta wEntityState.w, x	; 9d 70 04
B4_0e74:		lda #$01		; a9 01
B4_0e76:		sta wEntityFacingLeft.w, x	; 9d a8 04
B4_0e79:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_0ead:		sec				; 38 
B4_0eae:		lda wEntityBaseX.w, x	; bd 38 04
B4_0eb1:		sbc $10			; e5 10
B4_0eb3:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B4_0eb6:		sec				; 38 
B4_0eb7:		lda wEntityBaseY.w, x	; bd 1c 04
B4_0eba:		sbc $11			; e5 11
B4_0ebc:		sta wEntityVertSpeed.w, x	; 9d 20 05
B4_0ebf:		lda #$00		; a9 00
B4_0ec1:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B4_0ec4:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B4_1123:		lda wEntityState.w, x	; bd 70 04
B4_1126:		ora #$88		; 09 88
B4_1128:		sta wEntityState.w, x	; 9d 70 04
B4_112b:		lda #$88		; a9 88
B4_112d:		sta wOamSpecIdxDoubled.w, x	; 9d 00 04
...
B4_114d:		lda wEntityBaseX.w, x	; bd 38 04
B4_1150:		sta $12			; 85 12
B4_1152:		sta $10			; 85 10
B4_1154:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_116d:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_1192:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_11d8:		lda wPlayerStateDoubled.w, x	; bd 65 05
...
B4_1209:		lda wCurrRoomMetadataByte			; a5 68
...
B4_122f:		sta wEntityState.w, x	; 9d 70 04
B4_1232:		jsr $8627		; 20 27 86
B4_1235:		jsr $8661		; 20 61 86
B4_1238:		lda wEntityBaseX.w, x	; bd 38 04
B4_123b:		sec				; 38 
B4_123c:		sbc $12			; e5 12
B4_123e:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B4_1241:		lda wEntityBaseY.w, x	; bd 1c 04
B4_1244:		sec				; 38 
B4_1245:		sbc $13			; e5 13
B4_1247:		sta wEntityVertSpeed.w, x	; 9d 20 05
...
B4_1260:		sta wEntityState.w, x	; 9d 70 04
B4_1263:		lda #$01		; a9 01
B4_1265:		sta wEntityFacingLeft.w, x	; 9d a8 04
B4_1268:		lda wPlayerStateDoubled.w, x	; bd 65 05
B4_126b:		cmp #$80		; c9 80
B4_126d:		bcc B4_1274 ; 90 05

B4_126f:		lda #$00		; a9 00
B4_1271:		sta wEntityFacingLeft.w, x	; 9d a8 04
B4_1274:		lda wPlayerStateDoubled.w, x	; bd 65 05
B4_1277:		clc				; 18 
...
B4_128d:		sta wOamSpecIdxDoubled.w, x	; 9d 00 04
B4_1290:		lda #$0c		; a9 0c
B4_1292:		sta wEntityOamSpecGroupDoubled.w, x	; 9d 8c 04
B4_1295:		rts				; 60 
...
B4_1387:		lda wEntityState.w, x	; bd 70 04
B4_138a:		and #$01		; 29 01
B4_138c:		beq B4_13f5 ; f0 67

B4_138e:		lda #$00		; a9 00
B4_1390:		sta $00			; 85 00
B4_1392:		lda wEntityBaseY.w, x	; bd 1c 04
B4_1395:		jmp $93b6		; 4c b6 93


B4_1398:		lda wEntityState.w, x	; bd 70 04
...
B4_1429:		lda wEntityAI_idx.w, x	; bd ef 05
B4_142c:		and #$80		; 29 80
B4_142e:		ora $00			; 05 00
B4_1430:		sta wEntityAI_idx.w, x	; 9d ef 05
B4_1433:		lda #$00		; a9 00
B4_1435:		sta wEntityPhase.w, x	; 9d c1 05
B4_1438:		rts				; 60 


B4_1439:		lda wEntityState.w, x	; bd 70 04
B4_143c:		and #$01		; 29 01
B4_143e:		beq B4_1449 ; f0 09

B4_1440:		lda wEntityState.w, x	; bd 70 04
B4_1443:		ora #$88		; 09 88
B4_1445:		sta wEntityState.w, x	; 9d 70 04
B4_1448:		rts				; 60 


B4_1449:		lda #$40		; a9 40
B4_144b:		sta wEntityState.w, x	; 9d 70 04
B4_144e:		rts				; 60 


B4_144f:		lda #$00		; a9 00
B4_1451:		sta $00			; 85 00
B4_1453:		lda wEntityBaseX.w		; ad 38 04
B4_1456:		sec				; 38 
B4_1457:		sbc wEntityBaseX.w, x	; fd 38 04
...
B4_146a:		inc wEntityPhase.w, x	; fe c1 05
B4_146d:		rts				; 60 
...
B4_148f:		lda wEntityState.w, x	; bd 70 04
B4_1492:		sta wEntityState.w, y	; 99 70 04
B4_1495:		lda $02			; a5 02
B4_1497:		sta wEntityAI_idx.w, y	; 99 ef 05
...
B4_14af:		lda wEntityBaseX.w, y	; b9 38 04
B4_14b2:		sta wEntityBaseX.w, x	; 9d 38 04
B4_14b5:		lda wEntityBaseY.w, y	; b9 1c 04
B4_14b8:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_14bb:		txa				; 8a 
B4_14bc:		tay				; a8 
...
B4_14ce:		clc				; 18 
B4_14cf:		adc wEntityBaseX.w, x	; 7d 38 04
B4_14d2:		sta wEntityBaseX.w, x	; 9d 38 04
B4_14d5:		iny				; c8 
B4_14d6:		lda ($02), y	; b1 02
B4_14d8:		clc				; 18 
B4_14d9:		adc wEntityBaseY.w, x	; 7d 1c 04
B4_14dc:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B4_153d:		sta wEntityAI_idx.w, x	; 9d ef 05
B4_1540:		lda #$00		; a9 00
B4_1542:		sta wEntityPhase.w, x	; 9d c1 05
B4_1545:		rts				; 60 
...
B4_155a:		lda wPlayerStateDoubled.w, x	; bd 65 05
B4_155d:		and #$08		; 29 08
B4_155f:		beq B4_1564 ; f0 03

B4_1561:		jsr $95cd		; 20 cd 95
B4_1564:		lda $00			; a5 00
B4_1566:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B4_1569:		lda $01			; a5 01
B4_156b:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B4_156e:		ldy #$01		; a0 01
B4_1570:		lda ($02), y	; b1 02
B4_1572:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B4_1575:		iny				; c8 
B4_1576:		lda ($02), y	; b1 02
B4_1578:		sta wEntityVertSpeed.w, x	; 9d 20 05
B4_157b:		inc wEntityPhase.w, x	; fe c1 05
B4_157e:		rts				; 60 
...
B4_1585:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B4_1588:		clc				; 18 
B4_1589:		adc $00			; 65 00
B4_158b:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B4_158e:		lda wEntityVertSpeed.w, x	; bd 20 05
B4_1591:		adc #$00		; 69 00
B4_1593:		sta wEntityVertSpeed.w, x	; 9d 20 05
B4_1596:		lda wEntityVertSpeed.w, x	; bd 20 05
...
B4_15ae:		lda wEntityVertSpeed.w, x	; bd 20 05
B4_15b1:		cmp $00			; c5 00
B4_15b3:		bcs B4_15be ; b0 09

B4_15b5:		bne B4_15c8 ; d0 11

B4_15b7:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B4_15ba:		cmp $01			; c5 01
B4_15bc:		bcs B4_15c8 ; b0 0a

B4_15be:		lda $00			; a5 00
B4_15c0:		sta wEntityVertSpeed.w, x	; 9d 20 05
B4_15c3:		lda $01			; a5 01
B4_15c5:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B4_15c8:		rts				; 60 
...
B4_15e8:		clc				; 18 
B4_15e9:		adc wEntityBaseY.w, x	; 7d 1c 04
B4_15ec:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_15ef:		iny				; c8 
...
B4_15fa:		clc				; 18 
B4_15fb:		adc wEntityBaseX.w, x	; 7d 38 04
B4_15fe:		sta wEntityBaseX.w, x	; 9d 38 04
B4_1601:		jmp $946a		; 4c 6a 94


B4_1604:		lda wEntityState.w, x	; bd 70 04
B4_1607:		and #$01		; 29 01
B4_1609:		beq B4_1616 ; f0 0b

B4_160b:		lda wEntityState.w, x	; bd 70 04
B4_160e:		ora #$08		; 09 08
B4_1610:		sta wEntityState.w, x	; 9d 70 04
B4_1613:		jmp $946a		; 4c 6a 94


B4_1616:		lda wEntityState.w, x	; bd 70 04
B4_1619:		and #$77		; 29 77
B4_161b:		sta wEntityState.w, x	; 9d 70 04
B4_161e:		jmp $946a		; 4c 6a 94


B4_1621:		lda wEntityState.w, x	; bd 70 04
B4_1624:		ora #$08		; 09 08
B4_1626:		sta wEntityState.w, x	; 9d 70 04
B4_1629:		jmp $946a		; 4c 6a 94


B4_162c:		lda wEntityState.w, x	; bd 70 04
...
B4_166e:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_1691:		stx wVramQueueNextIdxToFill			; 86 1d
...
B4_16d1:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_16ec:		stx wVramQueueNextIdxToFill			; 86 1d
B4_16ee:		ldx $07			; a6 07
B4_16f0:		jmp $946a		; 4c 6a 94


B4_16f3:		sta wVramQueue.w, x	; 9d 00 03
B4_16f6:		inx				; e8 
B4_16f7:		rts				; 60 
...
B4_1736:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B4_1739:		sta wEntityVertSpeed.w, x	; 9d 20 05
B4_173c:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B4_173f:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B4_1757:		lda wEntityFacingLeft.w, x	; bd a8 04
B4_175a:		beq B4_1768 ; f0 0c

B4_175c:		lda wEntityBaseX.w, x	; bd 38 04
B4_175f:		sec				; 38 
B4_1760:		sbc $00			; e5 00
B4_1762:		sta wEntityBaseX.w, x	; 9d 38 04
B4_1765:		jmp $9771		; 4c 71 97


B4_1768:		lda wEntityBaseX.w, x	; bd 38 04
B4_176b:		clc				; 18 
B4_176c:		adc $00			; 65 00
B4_176e:		sta wEntityBaseX.w, x	; 9d 38 04
B4_1771:		ldy #$02		; a0 02
B4_1773:		lda ($02), y	; b1 02
B4_1775:		clc				; 18 
B4_1776:		adc wEntityBaseY.w, x	; 7d 1c 04
B4_1779:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B4_17c9:		lda wCurrRoomGroup		; a5 32
...
B4_189d:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_18d3:		stx wVramQueueNextIdxToFill			; 86 1d
B4_18d5:		rts				; 60 
...
B4_1900:		lda wCurrRoomMetadataByte			; a5 68
...
B4_192a:		lda wEntityBaseY.w, x	; bd 1c 04
B4_192d:		sec				; 38 
B4_192e:		sbc #$10		; e9 10
B4_1930:		sta $14			; 85 14
B4_1932:		ldy wEntityBaseX.w, x	; bc 38 04
...
B4_198b:		jsr func_1f_1c1e		; 20 1e fc
B4_198e:		pla				; 68 
B4_198f:		sta $13			; 85 13
B4_1991:		pla				; 68 
B4_1992:		sta $12			; 85 12
B4_1994:		lda wEntityBaseX.w, x	; bd 38 04
...
B4_19c9:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_1a0d:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_1a42:		stx wVramQueueNextIdxToFill			; 86 1d
B4_1a44:		rts				; 60 


B4_1a45:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_1a79:		stx wVramQueueNextIdxToFill			; 86 1d
...
B4_1aa8:		stx wVramQueueNextIdxToFill			; 86 1d
B4_1aaa:		rts				; 60 


B4_1aab:		lda wEntityBaseY.w, x	; bd 1c 04
B4_1aae:		and #$f8		; 29 f8
B4_1ab0:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_1ab3:		jmp $946a		; 4c 6a 94


B4_1ab6:		lda #$00		; a9 00
B4_1ab8:		sta wEntityAI_idx.w, x	; 9d ef 05
B4_1abb:		sta wEntityPhase.w, x	; 9d c1 05
B4_1abe:		rts				; 60 
...
B4_1acd:		lda wEntityAI_idx.w, x	; bd ef 05
...
B4_1b04:		lda wEntityState.w, x	; bd 70 04
...
B4_1b46:		lda wEntityBaseY.w, x	; bd 1c 04
...
B4_1ba0:		lda wEntityBaseY.w, x	; bd 1c 04
B4_1ba3:		sec				; 38 
...
B4_1c75:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B4_1c90:		stx wVramQueueNextIdxToFill			; 86 1d
B4_1c92:		ldx $16			; a6 16
B4_1c94:		rts				; 60 


B4_1c95:		ldx #$1a		; a2 1a
B4_1c97:		lda wEntityState.w, x	; bd 70 04
...
B4_1cae:		sta wEntityState.w, x	; 9d 70 04
B4_1cb1:		lda $02			; a5 02
B4_1cb3:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_1cb6:		ldy $07			; a4 07
B4_1cb8:		lda ($9a), y	; b1 9a
B4_1cba:		sta wEntityBaseX.w, x	; 9d 38 04
...
B4_1cca:		sta wEntityState.w, x	; 9d 70 04
B4_1ccd:		lda $02			; a5 02
B4_1ccf:		sta wEntityBaseX.w, x	; 9d 38 04
B4_1cd2:		ldy $07			; a4 07
B4_1cd4:		lda ($9a), y	; b1 9a
B4_1cd6:		sta wEntityBaseY.w, x	; 9d 1c 04
B4_1cd9:		iny				; c8 
...
B4_1cf8:		sta wEntityOamSpecGroupDoubled.w, x	; 9d 8c 04
B4_1cfb:		lda #$00		; a9 00
B4_1cfd:		sta wOamSpecIdxDoubled.w, x	; 9d 00 04
B4_1d00:		lda #$01		; a9 01
B4_1d02:		sta wEntityFacingLeft.w, x	; 9d a8 04
...
B4_1d1b:		jsr func_04_1ea5		; 20 a5 9e
...
B4_1d34:		jsr func_04_1ea5		; 20 a5 9e
...
B4_1d4f:		jsr func_04_1e2d		; 20 2d 9e
B4_1d52:		rts				; 60 
...
func_04_1ea5:
B4_1ea5:		lda wCurrRoomGroup		; a5 32
B4_1ea7:		asl a			; 0a
B4_1ea8:		tay				; a8 
B4_1ea9:		lda data_05_0073.w, y	; b9 73 a0
B4_1eac:		sta $08			; 85 08
B4_1eae:		lda data_05_0073.w+1, y	; b9 74 a0
B4_1eb1:		sta $09			; 85 09

B4_1eb3:		lda wCurrRoomSection			; a5 33
B4_1eb5:		asl a			; 0a
B4_1eb6:		tay				; a8 
...
B4_1ec0:		ldy wCurrRoomIdx			; a4 34
