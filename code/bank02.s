...
B2_0003:		jsr func_02_090c		; 20 0c 89
B2_0006:		rts				; 60 
...
B2_0038:		lda wCurrRoomGroup		; a5 32
...
B2_0048:		ldy wCurrRoomGroup			; a4 32
...
B2_0161:		sta wInGameSubstate			; 85 2a
...
B2_016a:		sta wInGameSubstate			; 85 2a
...
B2_01c7:		lda wCurrPlayer.w		; ad 4e 05
...
B2_01e6:		sta wEntityOamSpecGroupDoubled.w, x	; 9d 8c 04
B2_01e9:		lda wEntityFacingLeft.w		; ad a8 04
B2_01ec:		sta wEntityFacingLeft.w, x	; 9d a8 04
B2_01ef:		lda #$40		; a9 40
B2_01f1:		sta wEntityState.w, x	; 9d 70 04
B2_01f4:		lda wEntityBaseX.w		; ad 38 04
B2_01f7:		sta wEntityBaseX.w, x	; 9d 38 04
B2_01fa:		lda wEntityBaseY.w		; ad 1c 04
B2_01fd:		sta wEntityBaseY.w, x	; 9d 1c 04
B2_0200:		lda wEntityState.w		; ad 70 04
B2_0203:		ora #$80		; 09 80
B2_0205:		sta wEntityState.w		; 8d 70 04
...
B2_0213:		lda wCurrPlayer.w		; ad 4e 05
...
B2_022f:		sta wOamSpecIdxDoubled.w, x	; 9d 00 04
...
B2_0245:		lda wCurrRoomGroup		; a5 32
...
func_02_028e:
	ldy #$02
B2_0290:		jsr func_02_090c		; 20 0c 89
B2_0293:		rts				; 60 
...
B2_029e:	.db $93
B2_029f:	.db $83
B2_02a0:		lda wCurrRoomGroup		; a5 32
...
B2_02b0:		ldy wCurrRoomGroup			; a4 32
...
B2_0356:		sta wVramQueue.w, x	; 9d 00 03
B2_0359:		inx				; e8 
B2_035a:		rts				; 60 
...
B2_03b6:		sta wBaseIRQFuncIdx			; 85 3f
...
B2_03d1:		jsr func_02_090c		; 20 0c 89
B2_03d4:		rts				; 60 
...
B2_040f:		lda wCurrPlayer.w		; ad 4e 05
B2_0412:		beq B2_0419 ; f0 05

B2_0414:		txa				; 8a 
B2_0415:		tay				; a8 
B2_0416:		ldx $07f1		; ae f1 07
B2_0419:		lda wEntityBaseY.w, y	; b9 1c 04
B2_041c:		sta wEntityBaseY.w, x	; 9d 1c 04
B2_041f:		lda wEntityBaseX.w, y	; b9 38 04
B2_0422:		clc				; 18 
B2_0423:		adc #$10		; 69 10
B2_0425:		sta wEntityBaseX.w, x	; 9d 38 04
B2_0428:		lda wEntityState.w, x	; bd 70 04
B2_042b:		and #$7f		; 29 7f
B2_042d:		sta wEntityState.w, x	; 9d 70 04
...
B2_0460:		jsr func_02_090c		; 20 0c 89
B2_0463:		rts				; 60 
...
B2_04f8:		lda wPPUCtrl			; a5 ff
B2_04fa:		and #$fe		; 29 fe
B2_04fc:		sta wPPUCtrl			; 85 ff
...
B2_0531:		ldy wCurrRoomGroup			; a4 32
...
B2_0565:		ldy wCurrRoomGroup			; a4 32
...
B2_05a6:		lda wJoy1ButtonsPressed			; a5 28
...
B2_05fd:		lda wJoy1ButtonsPressed			; a5 28
...
B2_0609:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B2_0655:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_0676:		lda wJoy1NewButtonsPressed			; a5 26
...
B2_068d:		lda wJoy1NewButtonsPressed			; a5 26
...
B2_06b3:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B2_06d8:		stx wVramQueueNextIdxToFill			; 86 1d
B2_06da:		rts				; 60 
...
B2_07d6:		lda wCurrPlayer.w		; ad 4e 05
B2_07d9:		beq B2_07e6 ; f0 0b

B2_07db:		lda $3a			; a5 3a
B2_07dd:		sta wCurrPlayer.w		; 8d 4e 05
...
B2_07fa:		lda wCurrRoomGroup		; a5 32
...
B2_0877:		lda wCurrRoomGroup		; a5 32
...
B2_08ef:		sta wInGameSubstate			; 85 2a
...
func_02_090c:
B2_090c:		lda data_02_0929.w, y	; b9 29 89
B2_090f:		sta $00			; 85 00
B2_0911:		lda data_02_0929.w+1, y	; b9 2a 89
...
B2_097b:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B2_09c2:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_0a0e:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_0a21:		sta wVramQueue.w, x	; 9d 00 03
B2_0a24:		inx				; e8 
B2_0a25:		rts				; 60 
...
B2_0df6:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B2_0e7a:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_0e8c:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_0f03:		lda wCurrRoomGroup		; a5 32
B2_0f05:		asl a			; 0a
B2_0f06:		tay				; a8 
...
B2_1181:		jsr disableNMI_hideSpritesBg		; 20 82 e1
B2_1184:		lda #$00		; a9 00
B2_1186:		sta wScrollX			; 85 fd
B2_1188:		sta wScrollY			; 85 fc
...
B2_1265:		ldy wCurrRoomGroup			; a4 32
...
B2_12bf:	.db $02
B2_12c0:	.db $02
B2_12c1:		sta wOam.attr.w, x	; 9d 02 02
B2_12c4:	.db $9e
B2_12c5:	.db $02
B2_12c6:	.db $02
B2_12c7:	.db $9f
...
B2_12fb:		ldx wVramQueueNextIdxToFill			; a6 1d
...
B2_1356:		sta wVramQueue.w, x	; 9d 00 03
...
B2_13d3:		stx wVramQueueNextIdxToFill			; 86 1d
B2_13d5:		rts				; 60 
...
B2_1406:		lda wCurrRoomGroup		; a5 32
B2_1408:		asl a			; 0a
B2_1409:		tay				; a8 
...
B2_15e0:		sta wEntityBaseX.w, x	; 9d 38 04
B2_15e3:		inc $061d, x	; fe 1d 06
B2_15e6:		lda #$00		; a9 00
B2_15e8:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_15eb:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_15ee:		sta wEntityVertSpeed.w, x	; 9d 20 05
B2_15f1:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B2_1617:		sta wEntityState.w, x	; 9d 70 04
B2_161a:		rts				; 60 
...
B2_161e:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B2_1621:		clc				; 18 
B2_1622:		adc #$20		; 69 20
B2_1624:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B2_1686:		sta wEntityAnimationDefIdxInSpecGroup.w, x	; 9d aa 05
B2_1689:		rts				; 60 
...
B2_16bd:		sta wEntityState.w, x	; 9d 70 04
B2_16c0:		lda #$78		; a9 78
B2_16c2:		sta wEntityBaseX.w, x	; 9d 38 04
B2_16c5:		lda #$90		; a9 90
B2_16c7:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B2_1711:		asl a			; 0a
B2_1712:		clc				; 18 
B2_1713:		adc wEntityBaseY.w, y	; 79 1c 04
B2_1716:		sta wEntityBaseY.w, y	; 99 1c 04
...
B2_1720:		sta wEntityState.w, x	; 9d 70 04
B2_1723:		beq B2_172f ; f0 0a

B2_1725:		lda #$80		; a9 80
B2_1727:		sta wEntityState.w, x	; 9d 70 04
...
B2_173f:		sta wEntityState.w, x	; 9d 70 04
B2_1742:		jmp $9e0d		; 4c 0d 9e


B2_1745:		lda #$80		; a9 80
B2_1747:		sta wEntityState.w, x	; 9d 70 04
...
B2_1792:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B2_1795:		lda $97cb, y	; b9 cb 97
B2_1798:		sta wEntityVertSpeed.w, x	; 9d 20 05
B2_179b:		lda $97da, y	; b9 da 97
B2_179e:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_17a1:		lda $97db, y	; b9 db 97
B2_17a4:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_17a7:		inc $061d, x	; fe 1d 06
B2_17aa:		rts				; 60 


B2_17ab:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B2_17ae:		clc				; 18 
B2_17af:		adc #$20		; 69 20
B2_17b1:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B2_17ec:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B2_17ef:		lda #$00		; a9 00
B2_17f1:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B2_17f4:		sta wEntityVertSpeed.w, x	; 9d 20 05
B2_17f7:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_17fa:		sta wEntityHorizSpeed.w, x	; 9d f2 04
...
B2_182f:		sta wEntityPaletteOverride.w, x	; 9d 54 04
...
B2_184d:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B2_1850:		jmp $9e0d		; 4c 0d 9e


B2_1853:		lda #$01		; a9 01
B2_1855:		sta wEntityPaletteOverride.w, x	; 9d 54 04
...
B2_1888:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_188b:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_188e:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B2_1891:		clc				; 18 
B2_1892:		adc #$20		; 69 20
B2_1894:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B2_18ab:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B2_18cf:		sta wEntityBaseX.w, x	; 9d 38 04
B2_18d2:		lda #$a8		; a9 a8
B2_18d4:		sta wEntityBaseY.w, x	; 9d 1c 04
B2_18d7:		lda #$00		; a9 00
B2_18d9:		sta wEntityState.w, x	; 9d 70 04
...
B2_1941:		sta wEntityVertSpeed.w, x	; 9d 20 05
B2_1944:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
B2_1947:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_194a:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_194d:		rts				; 60 


B2_194e:		lda wEntityVertSubSpeed.w, x	; bd 37 05
B2_1951:		clc				; 18 
B2_1952:		adc #$10		; 69 10
B2_1954:		sta wEntityVertSubSpeed.w, x	; 9d 37 05
...
B2_196b:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B2_1989:		sta wEntityBaseY.w, x	; 9d 1c 04
...
B2_1a5d:		sta wEntityPaletteOverride.w, x	; 9d 54 04
...
B2_1a72:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_1a75:		lda #$00		; a9 00
B2_1a77:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_1a7a:		lda #$00		; a9 00
B2_1a7c:		sta wEntityFacingLeft.w, x	; 9d a8 04
B2_1a7f:		lda wEntityState.w, x	; bd 70 04
B2_1a82:		and #$01		; 29 01
B2_1a84:		beq B2_1a91 ; f0 0b

B2_1a86:		lda #$80		; a9 80
B2_1a88:		sta $00			; 85 00
B2_1a8a:		lda wEntityBaseX.w, x	; bd 38 04
...
B2_1a93:		sec				; 38 
B2_1a94:		sbc wEntityBaseX.w, x	; fd 38 04
...
B2_1aa4:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_1aa7:		lda #$00		; a9 00
B2_1aa9:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
B2_1aac:		lda #$01		; a9 01
B2_1aae:		sta wEntityFacingLeft.w, x	; 9d a8 04
B2_1ab1:		lda $00			; a5 00
B2_1ab3:		cmp #$03		; c9 03
B2_1ab5:		bcs B2_1af2 ; b0 3b

B2_1ab7:		lda #$00		; a9 00
B2_1ab9:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_1abc:		sta wEntityHorizSubSpeed.w, x	; 9d 09 05
...
B2_1acd:		sta wEntityFacingLeft.w, x	; 9d a8 04
B2_1ad0:		lda wEntityBaseX.w, x	; bd 38 04
...
B2_1b36:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B2_1b39:		lda #$80		; a9 80
B2_1b3b:		sta wEntityBaseX.w, x	; 9d 38 04
...
B2_1b71:		sta wEntityPaletteOverride.w, x	; 9d 54 04
B2_1b74:		lda #$76		; a9 76
B2_1b76:		sta wEntityBaseX.w, x	; 9d 38 04
B2_1b79:		lda #$00		; a9 00
B2_1b7b:		sta $07ef		; 8d ef 07
B2_1b7e:		sta $07f0		; 8d f0 07
B2_1b81:		lda wEntityFacingLeft.w, x	; bd a8 04
B2_1b84:		eor #$01		; 49 01
B2_1b86:		sta wEntityFacingLeft.w, x	; 9d a8 04
...
B2_1ba6:		sta wEntityState.w, x	; 9d 70 04
B2_1ba9:		rts				; 60 
...
B2_1c45:		lda wEntityBaseX.w, x	; bd 38 04
B2_1c48:		cmp #$04		; c9 04
B2_1c4a:		bcc B2_1c80 ; 90 34

B2_1c4c:		lda #$01		; a9 01
B2_1c4e:		sta wEntityFacingLeft.w, x	; 9d a8 04
B2_1c51:		bne B2_1c5f ; d0 0c

B2_1c53:		lda wEntityBaseX.w, x	; bd 38 04
B2_1c56:		cmp #$fc		; c9 fc
B2_1c58:		bcs B2_1c80 ; b0 26

B2_1c5a:		lda #$00		; a9 00
B2_1c5c:		sta wEntityFacingLeft.w, x	; 9d a8 04
...
B2_1c79:		sta wEntityState.w, x	; 9d 70 04
...
B2_1cc6:		sec				; 38 
B2_1cc7:		sbc wEntityBaseX.w, x	; fd 38 04
...
B2_1cd9:		sta wEntityHorizSpeed.w, x	; 9d f2 04
B2_1cdc:		lda $00			; a5 00
B2_1cde:		beq B2_1ce5 ; f0 05

B2_1ce0:		lda #$01		; a9 01
B2_1ce2:		sta wEntityHorizSpeed.w, x	; 9d f2 04
...
B2_1cf6:		sta wEntityFacingLeft.w, x	; 9d a8 04
...
B2_1d12:		lda wEntityBaseX.w, x	; bd 38 04
B2_1d15:		sta wEntityBaseX.w, y	; 99 38 04
...
B2_1d41:		ldx wVramQueueNextIdxToFill			; a6 1d
B2_1d43:		ldy #$00		; a0 00
B2_1d45:		lda #$01		; a9 01
B2_1d47:		sta wVramQueue.w, x	; 9d 00 03
B2_1d4a:		inx				; e8 
B2_1d4b:		lda ($00), y	; b1 00
B2_1d4d:		cmp #$ff		; c9 ff
B2_1d4f:		beq B2_1d59 ; f0 08

B2_1d51:		sta wVramQueue.w, x	; 9d 00 03
B2_1d54:		iny				; c8 
B2_1d55:		inx				; e8 
...
B2_1d5b:		sta wVramQueue.w, x	; 9d 00 03
B2_1d5e:		inx				; e8 
B2_1d5f:		stx wVramQueueNextIdxToFill			; 86 1d
B2_1d61:		lda #$04		; a9 04
B2_1d63:		jsr displayStaticLayoutA		; 20 e9 ec
...
B2_1d95:		ldx wVramQueueNextIdxToFill			; a6 1d
B2_1d97:		ldy #$00		; a0 00
B2_1d99:		lda $9daa, y	; b9 aa 9d
B2_1d9c:		sta wVramQueue.w, x	; 9d 00 03
B2_1d9f:		iny				; c8 
B2_1da0:		inx				; e8 
B2_1da1:		cpy #$0a		; c0 0a
B2_1da3:		bne B2_1d99 ; d0 f4

B2_1da5:		stx wVramQueueNextIdxToFill			; 86 1d
...
B2_1db3:		.db $00				; 00
B2_1db4:		sta wEntityOamSpecGroupDoubled.w, x	; 9d 8c 04
B2_1db7:		tya				; 98 
B2_1db8:		sta wEntityAnimationDefIdxInSpecGroup.w, x	; 9d aa 05
B2_1dbb:		lda #$00		; a9 00
B2_1dbd:		sta wEntityOamSpecIdxBaseOffset.w, x	; 9d 93 05
B2_1dc0:		jsr $ef7b		; 20 7b ef
B2_1dc3:		rts				; 60 


B2_1dc4:		lda wEntityOamSpecIdxBaseOffset.w, x	; bd 93 05
B2_1dc7:		bne B2_1dcf ; d0 06

B2_1dc9:		ldy wEntityTimeUntilNextAnimation.w, x	; bc 7c 05
B2_1dcc:		dey				; 88 
B2_1dcd:		beq B2_1dd4 ; f0 05

B2_1dcf:		jsr updateEntityXanimationFrame		; 20 75 ef
B2_1dd2:		clc				; 18 
B2_1dd3:		rts				; 60 
...
B2_1e00:		tya				; 98 
B2_1e01:		sta wEntityAnimationDefIdxInSpecGroup.w, x	; 9d aa 05
B2_1e04:		lda #$00		; a9 00
B2_1e06:		sta wEntityOamSpecIdxBaseOffset.w, x	; 9d 93 05
B2_1e09:		sta wEntityTimeUntilNextAnimation.w, x	; 9d 7c 05
B2_1e0c:		rts				; 60 


B2_1e0d:		lda wEntityTimeUntilNextAnimation.w, x	; bd 7c 05
B2_1e10:		bne B2_1e40 ; d0 2e

B2_1e12:		lda wEntityAnimationDefIdxInSpecGroup.w, x	; bd aa 05
B2_1e15:		asl a			; 0a
B2_1e16:		tay				; a8 
...
B2_1e21:		lda wEntityOamSpecIdxBaseOffset.w, x	; bd 93 05
...
B2_1e34:		sta wEntityTimeUntilNextAnimation.w, x	; 9d 7c 05
B2_1e37:		iny				; c8 
B2_1e38:		lda ($00), y	; b1 00
B2_1e3a:		sta wOamSpecIdxDoubled.w, x	; 9d 00 04
B2_1e3d:		inc wEntityOamSpecIdxBaseOffset.w, x	; fe 93 05
B2_1e40:		dec wEntityTimeUntilNextAnimation.w, x	; de 7c 05
B2_1e43:		clc				; 18 
B2_1e44:		rts				; 60 


B2_1e45:		lda #$00		; a9 00
B2_1e47:		sta wEntityOamSpecIdxBaseOffset.w, x	; 9d 93 05
B2_1e4a:		sta wEntityTimeUntilNextAnimation.w, x	; 9d 7c 05
B2_1e4d:		clc				; 18 
B2_1e4e:		rts				; 60 


B2_1e4f:		lda #$00		; a9 00
B2_1e51:		sta wEntityTimeUntilNextAnimation.w, x	; 9d 7c 05
B2_1e54:		lda #$ff		; a9 ff
B2_1e56:		sta wEntityOamSpecIdxBaseOffset.w, x	; 9d 93 05
B2_1e59:		sec				; 38 
B2_1e5a:		rts				; 60 
